...
import { EmbedderService, embedderLayerOf } from '../formal/embedder.ts'
import { ErrDocNotFound, ErrEmbedModelMissing, type OperationalError } from '../kernel/errors.ts'
import { EXIT_CLEAN, exitCodeForEnvelope } from '../kernel/exit.ts'
